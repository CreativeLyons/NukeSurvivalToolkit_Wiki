...
![additive-keyer-pro-3.webp](../img/tools/keyer/additive-keyer-pro-3.webp)
...
- **FG** - Foreground plate
  ...
  <img src="../img/tools/keyer/additive-keyer-pro-2.webp" alt="FG input" width="75%">

- **Clean** - Clean plate

  <img src="../img/tools/keyer/additive-keyer-pro-1.webp" alt="Clean input" width="75%">

- **BG** - Background plate

  <img src="../img/tools/keyer/additive-keyer-pro-5.webp" alt="BG input" width="75%">

- **Result** - Final composite output

  <img src="../img/tools/keyer/additive-keyer-pro-4.webp" alt="Result output" width="75%">
